    ...
    return (
        <div className={styles.gerb1Page}>
            ...
            <main>
                ...
                <img src={`${process.env.PUBLIC_URL}/resourses/pechati/oooAndIp.png`} alt="ип и ооо"/>
                ...
                <div className={styles.interactivePartWrapper}>
                    ...
                    <div className={styles.orderBtns}>
                        <button id="addToBasket" className={styles.addToBasket} data-artikul="businessOoo" onClick={handleAddToCart}>Добавить в корзину</button>
                    </div>
                </div>
